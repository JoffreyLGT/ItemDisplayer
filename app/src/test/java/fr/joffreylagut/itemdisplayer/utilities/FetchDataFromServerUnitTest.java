...
/**
 * FetchDataFromServerUnitTest.java
 * Purpose: Handle the unit tests of FetchDataFromServer.java
 *
...
public class FetchDataFromServerUnitTest {
    ...
    public void convertJSONResponseInPhoto() throws Exception {
        ...
        // Run
        List<Photo> photosFromServer = FetchDataFromServer.convertJSONResponseInPhoto(jsonExample);
